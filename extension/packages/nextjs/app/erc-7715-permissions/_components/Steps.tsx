  ...
  return (
    <div className="flex flex-col gap-6 lg:gap-8 py-6 lg:py-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="text-center">
        <h1 className="text-3xl font-bold tracking-tight text-white">ERC-7715 Permissions</h1>
        <p className="mt-2 text-base text-white">Execute transactions on behalf of MetaMask users</p>
      </div>

      <div className="w-full flex flex-col min-h-screen gap-4">
        {grantedPermissions && (
          <div className="w-full max-w-2xl">
            <div className="border-2 border-gray-300 rounded-lg p-8 bg-gray-900">
              <h3 className="text-xl font-semibold text-white mb-2">Approved Permission</h3>
        ...
        {error && (
          <div className="w-full max-w-2xl">
            <div className="border-2 border-red-500 rounded-lg p-8 bg-gray-900">
